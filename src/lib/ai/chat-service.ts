...
function extractProductIdsFromText(text: string): string[] {
  ...
  products.forEach((p) => {
    ...
    if (textLower.includes("salicylic") || textLower.includes("bha") || textLower.includes("acne serum") || textLower.includes("pore serum")) matchedIds.add("tdc-salicylic-serum");
    if (textLower.includes("niacinamide") || textLower.includes("b3") || textLower.includes("marks serum") || textLower.includes("spot serum")) matchedIds.add("tdc-niacinamide-serum");
    if (textLower.includes("sunscreen") || textLower.includes("spf") || textLower.includes("uv shield")) matchedIds.add("aq-glow-sunscreen");
    if (textLower.includes("gel") || textLower.includes("moisturiser") || textLower.includes("hydration") || textLower.includes("water gel")) matchedIds.add("aq-hydrate-gel");
    if (textLower.includes("vit c") || textLower.includes("vitamin c") || textLower.includes("haldi") || textLower.includes("orange serum") || textLower.includes("mamarth vit c")) matchedIds.add("ds-haldi-vitc-serum");
    ...
    if (textLower.includes("night cream") || textLower.includes("renewal cream") || textLower.includes("overnight") || textLower.includes("peptide cream")) matchedIds.add("lu-night-repair-cream");
